...
urlpatterns = [
    ...
    path('ungroupid/', views.UnGroupIdView.as_view()),
    ...
    path('sort_ungroup/', views.sort_ungroup_list),
    path('ungroup/', views.ungrouplist),
    # path('ungroup/', views.UnGroupView.as_view()),
